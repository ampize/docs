...
* Analytics : allows configuration if analytics type and vars json. For more details please read the [official docs](https://developers.google.com/analytics/devguides/collection/amp-analytics/).
